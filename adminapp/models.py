...
class Clienteindividual(models.Model):
    usuarioi = models.CharField(db_column='usuarioI', primary_key=True, max_length=20)  # Field name made lowercase.
